		...
		case (!isNull _displayAdmin): //Admin panel
		{
			...
			switch (lbCurSel _adminSelect) do
			{
				...
				case 2: //Tags
				{
					...
					if (!isNil "notifyAdminMenu") then { ["playermarkers", "playertags"] call notifyAdminMenu };
				};
				case 3: //Teleport
				{
					closeDialog 0;
				...
				case 7: // toggle God mode
				{
					...
					if (!isNil "notifyAdminMenu") then { ["godmode"] call notifyAdminMenu };
				};
				case 8: //building store
				{
					closeDialog 0;
