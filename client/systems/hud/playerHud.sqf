...
while {true} do
{
	...
	_missionUptimeText = _ui displayCtrl missionUptimeText;
	_timeText = [time/60/60] call BIS_fnc_timeToString;
	_missionUptimeText ctrlSetStructuredText parseText format["<t align='center' color='#6B802D' font='PuristaBold' shadow='2' shadowColor='#000000' size='1'>Server Uptime: </t><t align='center' color='#FFFFFF' font='PuristaBold' shadow='2' shadowColor='#000000' size='1'>%1</t><t align='right' color='#6B802D' font='PuristaBold' size='1'>Website: </t><t align='right' color='#FFFFFF' font='PuristaBold' shadow='2' shadowColor='#000000' size='1'>www.</t><t align='right' color='#FFFFFF' font='PuristaBold' shadow='2' shadowColor='#000000' size='1'>fps</t><t align='right' color='#ffffff' font='PuristaBold' shadow='2' shadowColor='#000000' size='1'>underground</t><t align='right' color='#ffffff' font='PuristaBold' shadow='2' shadowColor='#000000' size='1'>.com</t><br/><t align='right' color='#6B802D' font='PuristaBold' size='1'>TeamSpeak 3: </t><t align='right' color='#ffffff' font='PuristaBold' shadow='2' shadowColor='#000000' size='1'>ts.</t><t align='right' color='#ffffff' font='PuristaBold' shadow='2' shadowColor='#000000' size='1'>fpsugaming</t><t align='right' color='#ffffff' font='PuristaBold' shadow='2' shadowColor='#000000' size='1'>.com</t>", _timeText];
	...
	{
		_tempString = format ["<t color='#A0FFFFFF'>FPSU A3Wasteland %1<br/>www.fpsunderground.com</t>", getText (configFile >> "CfgWorlds" >> worldName >> "description")];
		_yOffset = 0.28;
